...
const navItems = [
  ...
  { title: 'Attendance', href: '/attendance', icon: <CalendarCheck size={18} /> },
  { title: 'Payroll', href: '/payroll', icon: <Wallet size={18} /> },
  { title: 'Recruitment', href: '/recruitment', icon: <Briefcase size={18} /> },
  { title: 'Compliance and Documentation', href: '/documents', icon: <FileBadge size={18} /> },
