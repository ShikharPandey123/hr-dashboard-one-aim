...
export default function DailyAttendance() {
  ...
  return (
    <div className="bg-white border rounded-xl p-6 shadow-sm text-gray-800">
      ...
      <p className="text-sm text-gray-600 mb-6">Overview of attendance records as of <span className="font-medium">{getToday()}</span></p>

      {/* Today row (example) */}
      <div className="mb-6 border border-red-100 rounded-lg p-4 bg-red-50/40">
        <p className="font-semibold text-red-600 mb-1">Today’s Snapshot</p>
        <div className="text-sm text-gray-700">✔️ Present: <span className="font-medium text-blue-600">45</span> | ❌ Absent: <span className="font-medium text-red-600">6</span> | 📋 Leaves: <span className="font-medium text-purple-600">2</span></div>
      </div>
      ...
      {data && (
        <div>
          <h3 className="text-md font-semibold text-gray-700 mb-3">
            📊 Attendance Summary - <span className="text-red-600">{getPreviousMonthName()}</span>
          </h3>
