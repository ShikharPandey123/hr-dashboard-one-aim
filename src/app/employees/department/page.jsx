...
export default function DepartmentAssignment() {
  ...
  return (
    <div className="bg-white border rounded-xl p-4 sm:p-6 shadow-sm">
      <h2 className="text-base sm:text-lg font-semibold mb-4 text-gray-800">🏢 Department Assignment</h2>
      ...
      <div className="sm:hidden space-y-4">
        {assignments.map(emp => (
          <div key={emp.id} className="border rounded-lg p-3 shadow-sm bg-red-50 text-gray-900 space-y-1">
